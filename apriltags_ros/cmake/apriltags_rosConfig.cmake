...
if("FALSE" STREQUAL "TRUE")
  set(apriltags_ros_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-apriltags-ros-0.1.2)
  set(apriltags_ros_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-apriltags-ros-0.1.2/obj-x86_64-linux-gnu/devel)
  ...
  set(apriltags_ros_INSTALL_PREFIX /opt/ros/indigo)
...
if(NOT "include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltags_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Mitchell Wills <mwills@wpi.edu>' to fix it.")
    endif()
